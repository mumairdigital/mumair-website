...
export const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Free HVAC Market Audit",
    description: "I audit your Google Business Profile, website, citations, and competitor rankings to map the exact opportunity in your local market. You get a clear picture before spending a dollar.",
    icon: "Search",
  },
  {
    step: "02",
    title: "HVAC Strategy Call",
    description: "We talk through the audit findings together. I explain what's holding your HVAC company back from page one — and exactly what it will take to get there. No jargon, no fluff.",
    icon: "Map",
  },
  {
    step: "03",
    title: "Implementation",
    description: "I optimize your GBP, build local citations, fix technical issues, and set up your review generation system. Every action is tracked and reported with real data.",
    icon: "Zap",
  },
  {
    step: "04",
    title: "Monthly Reporting & Growth",
    description: "Every month you get a report showing real Search Console data, ranking movement, and call trends. The results compound — Local SEO builds authority that keeps paying off over time.",
    icon: "TrendingUp",
  },
];
